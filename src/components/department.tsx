...
export default function Department() {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      ...
      try {
        const response = await axios.get('http://195.158.9.124:4109/department', {
          headers: {
  ...
  const handleDelete = async (id: string) => {
    try {
      await axios.delete(`http://195.158.9.124:4109/department/${id}`, {
        headers: {
  ...
  const handleAddDepartment = async () => {
    ...
    try {
      const response = await axios.post('http://195.158.9.124:4109/department', {
  ...
  const handleUpdateDepartment = async () => {
    ...
    try {
      const response = await axios.put(`http://195.158.9.124:4109/department`, {
